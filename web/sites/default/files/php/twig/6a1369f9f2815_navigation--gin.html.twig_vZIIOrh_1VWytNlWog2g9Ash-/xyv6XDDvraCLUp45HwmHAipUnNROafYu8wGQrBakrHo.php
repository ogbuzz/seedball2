...
class __TwigTemplate_64657aac0d988a19f18205be59776399 extends Template
{
...
<script>
  if (localStorage.getItem(\x27Drupal.navigation.sidebarExpanded\x27) !== \x27false\x27) {
    document.documentElement.classList.add(\x27admin-toolbar-expanded\x27);
  }
</script>
";
